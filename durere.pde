...
void setup() {   
 ...
 /**
 file1 = new SoundFile(this,"Ab_H_no_01.wav");
 file2 = new SoundFile(this,"Bb_H_no_01.wav");
 file3 = new SoundFile(this,"C_H_no_01.wav");
 file4 = new SoundFile(this,"Db_H_no_01.wav");
 file5 = new SoundFile(this,"Eb_H_no_01.wav");
 file6 = new SoundFile(this,"F_H_no_01.wav");
 file7 = new SoundFile(this,"G_H_no_01.wav");  */
}  
